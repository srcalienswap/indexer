...
async function main() {
    ...
    const conduitControllerAddress = "0x00000000F9490004C11Cef243f5400493c00Ad63"; // hal
    ...
    const alienswapAddress = "0x47D6757CC474A95B9536156C7f35AD48A0D4D999"; // hal
    ...
    const conduitAddress = "0xc66782106B1B64e1E3d94b92e979d06745a6F6eB"; // hal
